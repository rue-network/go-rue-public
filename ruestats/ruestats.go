...
// Service implements an Ruereum netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Ruereum      // Full Ruereum service if monitoring a full node
...
func New(url string, ethServ *eth.Ruereum, lesServ *les.LightRuereum) (*Service, error) {
