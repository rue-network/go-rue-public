...
import (
	...
	"github.com/Rue-Foundation/go-rue/swarm/fuse"
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *rueclient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
