...
type Vote struct {
	...
	Authorize bool           `json:"authorize"` // Whrueer to authorize or deauthorize the voted account
}

// Tally is a simple vote tally to keep the current score of votes. Votes that
// go against the proposal aren't counted since it's equivalent to not voting.
type Tally struct {
	Authorize bool `json:"authorize"` // Whrueer the vote is about authorizing or kicking someone
...
// validVote returns whrueer it makes sense to cast the specified vote in the
