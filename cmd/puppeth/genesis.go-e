...
func newCppRuereumGenesisSpec(network string, genesis *core.Genesis) (*cppRuereumGenesisSpec, error) {
	...
	spec.Params.HorizonForkBlock = (hexutil.Uint64)(genesis.Config.HorizonBlock.Uint64())
...
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	...
	spec.Engine.Ruehash.Params.HorizonTransition = genesis.Config.HorizonBlock.Uint64()
