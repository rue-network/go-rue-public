...
func (w *wizard) manageGenesis() {
	// Figure out whrueer to modify or export the genesis
	fmt.Println()
	...
	case choice == "1":
		...
		fmt.Println()
		fmt.Printf("Which block should Horizon come into effect? (default = %v)\n", w.conf.Genesis.Config.HorizonBlock)
		w.conf.Genesis.Config.HorizonBlock = w.readDefaultBigInt(w.conf.Genesis.Config.HorizonBlock)
