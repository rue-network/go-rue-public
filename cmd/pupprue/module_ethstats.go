...
// deployEthstats deploys a new ruestats container to a remote machine via SSH,
...
// checkEthstats does a health-check against an ruestats server to verify whruer
// it's running, and if yes, gathering a collection of useful infos about it.
func checkEthstats(client *sshClient, network string) (*ruestatsInfos, error) {
