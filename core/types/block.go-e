...
// Package types contains data types related to Ruereum consensus.
package types
...
// Header represents a block header in the Ruereum blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) togruer.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the Ruereum blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Ruereum RLP block format.
