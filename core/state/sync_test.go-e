...
func makeTestState() (Database, *ruedb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := ruedb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db ruedb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db ruedb.Database, root common.Hash) error {
...
func checkStateConsistency(db ruedb.Database, root common.Hash) error {
