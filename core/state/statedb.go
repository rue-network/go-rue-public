...
// Package state provides a caching layer atop the Ruereum state trie.
package state
...
// StateDBs within the ruereum protocol are used to store anything
...
// Exist reports whruer the given account address exists in the state.
// Notably this also returns true for suicided accounts.
func (self *StateDB) Exist(addr common.Address) bool {
	return self.getStateObject(addr) != nil
}

// Empty returns whruer the state object is either non-existent
...
//
// Carrying over the balance ensures that Ruer doesn't disappear.
