...
// Syncing provides information when this nodes starts synchronising with the Ruereum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ruereum.SyncProgress `json:"status"`
}
