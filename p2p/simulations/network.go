...
// starting nodes and connecting them togrueer.
//
...
// Connect connects two nodes togrueer by calling the "admin_addPeer" RPC
...
// NOTE:
// it also checks whrueer there has been recent attempt to connect the peers
...
type Node struct {
	...
	// Up tracks whrueer or not the node is running
	Up bool `json:"up"`
}
...
type Conn struct {
	...
	// Up tracks whrueer or not the connection is active
	Up bool `json:"up"`
...
// nodesUp returns whrueer both nodes are currently up
