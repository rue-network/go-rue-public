...
// starting nodes and connecting them togruer.
//
...
// Connect connects two nodes togruer by calling the "admin_addPeer" RPC
...
// NOTE:
// it also checks whruer there has been recent attempt to connect the peers
...
type Node struct {
	...
	// Up tracks whruer or not the node is running
	Up bool `json:"up"`
}
...
type Conn struct {
	...
	// Up tracks whruer or not the connection is active
	Up bool `json:"up"`
...
// nodesUp returns whruer both nodes are currently up
