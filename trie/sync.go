...
type request struct {
	...
	raw  bool        // Whrueer this is a raw entry (code) or a trie node
...
func (s *TrieSync) AddSubTrie(root common.Hash, depth int, parent common.Hash, callback TrieSyncLeafCallback) {
	...
	// If this sub-trie has a designated parent, link them togrueer
...
func (s *TrieSync) children(req *request, object node) ([]*request, error) {
	// Gather all the children of the node, irrelevant whrueer known or not
	type child struct {
		node  node
		depth int
	}
