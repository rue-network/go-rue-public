...
var (
	/*	propTxnInPacketsMeter     = metrics.NewMeter("rue/prop/txns/in/packets")
		...
		reqHashInPacketsMeter     = metrics.NewMeter("rue/req/hashes/in/packets")
		reqHashInTrafficMeter     = metrics.NewMeter("rue/req/hashes/in/traffic")
		reqHashOutPacketsMeter    = metrics.NewMeter("rue/req/hashes/out/packets")
		reqHashOutTrafficMeter    = metrics.NewMeter("rue/req/hashes/out/traffic")
		reqBlockInPacketsMeter    = metrics.NewMeter("rue/req/blocks/in/packets")
		reqBlockInTrafficMeter    = metrics.NewMeter("rue/req/blocks/in/traffic")
		reqBlockOutPacketsMeter   = metrics.NewMeter("rue/req/blocks/out/packets")
		reqBlockOutTrafficMeter   = metrics.NewMeter("rue/req/blocks/out/traffic")
