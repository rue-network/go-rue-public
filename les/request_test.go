...
type accessTestFn func(db ruedb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db ruedb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db ruedb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db ruedb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db ruedb.Database, bhash common.Hash, number uint64) light.OdrRequest {
