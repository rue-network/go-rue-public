...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "grue.ipc", false, filepath.Join(os.TempDir(), "grue.ipc")},
		{"data", "grue.ipc", false, "data/grue.ipc"},
		{"data", "./grue.ipc", false, "./grue.ipc"},
		{"data", "/grue.ipc", false, "/grue.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "grue.ipc", true, `\\.\pipe\grue.ipc`},
		{"data", "grue.ipc", true, `\\.\pipe\grue.ipc`},
		{"data", `\\.\pipe\grue.ipc`, true, `\\.\pipe\grue.ipc`},
	}
