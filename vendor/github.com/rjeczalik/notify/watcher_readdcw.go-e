...
// in order to distinguish whruer current folder should be re-registered in
...
// watched is made in order to check whruer an action comes from a directory or
...
// gensys decides whruer the Windows action, system-independent event or both
