...
// in order to distinguish whrueer current folder should be re-registered in
...
// watched is made in order to check whrueer an action comes from a directory or
...
// gensys decides whrueer the Windows action, system-independent event or both
