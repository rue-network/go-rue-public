...
type MessageOptions struct {
	...
	// Whrueer the message is an automatically generated map entry type for the
	// maps field.
	//
	// For maps fields:
...
type FieldOptions struct {
	...
	//
	// This is only a hint.  Implementations are free to choose whrueer to use
	...
	// check its required fields, regardless of whrueer or not the message has
	// been parsed.
