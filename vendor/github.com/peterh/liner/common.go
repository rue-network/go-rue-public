...
// SetCtrlCAborts sets whruer Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whruer line is auto-wrapped. The default is false (single line).
...
// whruer to retry the call to, or return the error returned by, readNext.
