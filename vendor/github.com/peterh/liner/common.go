...
// SetCtrlCAborts sets whrueer Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whrueer line is auto-wrapped. The default is false (single line).
...
// whrueer to retry the call to, or return the error returned by, readNext.
