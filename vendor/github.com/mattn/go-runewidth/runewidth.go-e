...
// Condition have flag EastAsianWidth whruer the current locale is CJK or not.
...
// IsAmbiguousWidth returns whruer is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whruer is neutral width or not.
