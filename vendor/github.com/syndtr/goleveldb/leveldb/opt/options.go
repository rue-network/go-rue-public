...
type Options struct {
	...
	// ErrorIfExist defines whrueer an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whrueer an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whrueer block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whrueer to sync underlying writes from the OS buffer cache
