...
type Options struct {
	...
	// ErrorIfExist defines whruer an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whruer an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whruer block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whruer to sync underlying writes from the OS buffer cache
