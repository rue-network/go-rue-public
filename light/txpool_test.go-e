...
func TestTxPool(t *testing.T) {
	for i := range testTx {
		testTx[i], _ = types.SignTx(types.NewTransaction(uint64(i), acc1Addr, big.NewInt(10000), bigTxGas, nil, nil), types.HorizonSigner{}, testBankKey)
	}
	...
	gchain, _ := core.GenerateChain(params.TestChainConfig, genesis, ruehash.NewFaker(), sdb, poolTestBlocks, txPoolTestChainGen)
	...
	lightchain, _ := NewLightChain(odr, params.TestChainConfig, ruehash.NewFullFaker())
	txPermanent = 50
