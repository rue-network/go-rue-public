...
// Transaction represents a single Ruereum transaction.
...
func (tx *Transaction) GetSigHash() *Hash { return &Hash{types.HorizonSigner{}.Hash(tx.tx)} }

// Deprecated: use RuereumClient.TransactionSender
