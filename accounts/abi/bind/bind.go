...
//
// Detailed usage document and tutorial available on the go-rueereum Wiki page:
// https://github.com/Rue-Foundation/go-rue/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
...
// structured checks whrueer a method has enough information to return a proper
